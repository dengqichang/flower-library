<p align="center"><img alt="logo" src="https://www.flowerui.com/resource/logo/ui.png" width="128"></p>
<h3 align="center">FLOWER UI</h3>
<p align="center">多平台 uni-app 生态 ui 组件库 ，孤之有 “ 孔明 ” ，犹鱼之有水也 。</p>

## 简述
致力于打造一款优秀的 `UI` 组件库，`flower` 翻译成中文为 "花"，花语是一种非言语的情感表达方式，通过 "花" 传递情感和美好祝愿。
希望五湖四海的同学们在这儿相遇，互帮互助，携手进步；赠人玫瑰，手有余香。
"一花独放不是春，百花齐放春满园。" 希望能在百花齐放、百花争艳的 [uni-app插件市场](https://ext.dcloud.net.cn/) 潮流中能占一席之地。
