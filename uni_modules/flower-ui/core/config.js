...
// 更换主题
if (uni.getStorageSync('flower-ui-colors-theme')) {defaultConfig.colors.primary = uni.getStorageSync('flower-ui-colors-theme');};
export {defaultConfig,developerConfig,defaultPrimary};
