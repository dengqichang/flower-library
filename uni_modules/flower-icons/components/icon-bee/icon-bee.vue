...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-bee", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-bee;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-bee;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-bee;}
	/* #endif */
