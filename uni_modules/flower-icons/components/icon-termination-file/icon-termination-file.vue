...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-termination-file", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-termination-file;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-termination-file;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-termination-file;}
	/* #endif */
