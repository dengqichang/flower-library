...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-left-small-down", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-left-small-down;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-left-small-down;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-left-small-down;}
	/* #endif */
