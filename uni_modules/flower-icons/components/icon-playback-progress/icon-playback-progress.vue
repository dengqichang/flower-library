...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-playback-progress",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-playback-progress;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-playback-progress;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-playback-progress;}
	/* #endif */
