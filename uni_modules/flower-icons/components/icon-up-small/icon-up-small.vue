...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-up-small",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-up-small;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-up-small;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-up-small;}
	/* #endif */
