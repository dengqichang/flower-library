...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-viewfinder", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-viewfinder;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-viewfinder;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-viewfinder;}
	/* #endif */
