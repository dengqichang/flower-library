...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-multi-triangular-three", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-multi-triangular-three;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-multi-triangular-three;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-multi-triangular-three;}
	/* #endif */
