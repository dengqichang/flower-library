...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-circle-left-down",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-circle-left-down;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-circle-left-down;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-circle-left-down;}
	/* #endif */
