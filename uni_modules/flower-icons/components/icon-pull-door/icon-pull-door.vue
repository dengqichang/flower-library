...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-pull-door",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-pull-door;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-pull-door;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-pull-door;}
	/* #endif */
