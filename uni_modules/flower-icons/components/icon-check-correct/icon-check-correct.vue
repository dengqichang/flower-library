...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-check-correct",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-check-correct;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-check-correct;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-check-correct;}
	/* #endif */
