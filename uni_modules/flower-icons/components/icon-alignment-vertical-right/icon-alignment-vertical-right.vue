...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-alignment-vertical-right", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-alignment-vertical-right;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-alignment-vertical-right;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-alignment-vertical-right;}
	/* #endif */
