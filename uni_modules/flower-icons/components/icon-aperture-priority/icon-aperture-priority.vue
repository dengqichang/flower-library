...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-aperture-priority", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-aperture-priority;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-aperture-priority;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-aperture-priority;}
	/* #endif */
