...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-delete-mode", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-delete-mode;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-delete-mode;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-delete-mode;}
	/* #endif */
