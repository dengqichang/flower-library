...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-headphone-sound", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-headphone-sound;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-headphone-sound;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-headphone-sound;}
	/* #endif */
