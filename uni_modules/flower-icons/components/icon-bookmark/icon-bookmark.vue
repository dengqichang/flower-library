...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-bookmark", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-bookmark;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-bookmark;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-bookmark;}
	/* #endif */
