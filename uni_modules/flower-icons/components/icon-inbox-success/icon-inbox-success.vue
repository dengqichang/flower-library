...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-inbox-success", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-inbox-success;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-inbox-success;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-inbox-success;}
	/* #endif */
