...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-direction-adjustment", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-direction-adjustment;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-direction-adjustment;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-direction-adjustment;}
	/* #endif */
