...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-chicken-zodiac", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-chicken-zodiac;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-chicken-zodiac;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-chicken-zodiac;}
	/* #endif */
