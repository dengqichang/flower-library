...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-three-triangles", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-three-triangles;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-three-triangles;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-three-triangles;}
	/* #endif */
