...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-chef-hat", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-chef-hat;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-chef-hat;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-chef-hat;}
	/* #endif */
