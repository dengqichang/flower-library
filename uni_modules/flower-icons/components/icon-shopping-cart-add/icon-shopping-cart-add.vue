...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-shopping-cart-add", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-shopping-cart-add;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-shopping-cart-add;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-shopping-cart-add;}
	/* #endif */
