...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-electric-drill", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-electric-drill;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-electric-drill;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-electric-drill;}
	/* #endif */
