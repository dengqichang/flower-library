...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-arrow-left-down", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-arrow-left-down;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-arrow-left-down;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-arrow-left-down;}
	/* #endif */
