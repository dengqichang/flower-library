...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-sliding-horizontal",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-sliding-horizontal;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-sliding-horizontal;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-sliding-horizontal;}
	/* #endif */
