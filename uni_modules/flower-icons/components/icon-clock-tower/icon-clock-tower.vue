...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-clock-tower", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-clock-tower;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-clock-tower;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-clock-tower;}
	/* #endif */
