...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-font-size-one", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-font-size-one;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-font-size-one;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-font-size-one;}
	/* #endif */
