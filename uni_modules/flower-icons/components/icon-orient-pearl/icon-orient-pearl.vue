...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-orient-pearl", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-orient-pearl;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-orient-pearl;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-orient-pearl;}
	/* #endif */
