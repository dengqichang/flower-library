...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-error-picture", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-error-picture;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-error-picture;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-error-picture;}
	/* #endif */
