...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-file-addition", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-file-addition;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-file-addition;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-file-addition;}
	/* #endif */
