...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-expressionless-face",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-expressionless-face;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-expressionless-face;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-expressionless-face;}
	/* #endif */
