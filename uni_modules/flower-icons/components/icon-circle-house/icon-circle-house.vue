...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-circle-house", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-circle-house;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-circle-house;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-circle-house;}
	/* #endif */
