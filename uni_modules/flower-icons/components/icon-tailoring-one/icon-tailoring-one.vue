...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-tailoring-one",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-tailoring-one;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-tailoring-one;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-tailoring-one;}
	/* #endif */
