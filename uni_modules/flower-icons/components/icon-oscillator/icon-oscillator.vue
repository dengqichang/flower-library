...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-oscillator", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-oscillator;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-oscillator;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-oscillator;}
	/* #endif */
