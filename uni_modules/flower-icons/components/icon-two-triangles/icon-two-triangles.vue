...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-two-triangles",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-two-triangles;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-two-triangles;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-two-triangles;}
	/* #endif */
