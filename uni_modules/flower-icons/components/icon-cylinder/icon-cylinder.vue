...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-cylinder",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-cylinder;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-cylinder;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-cylinder;}
	/* #endif */
