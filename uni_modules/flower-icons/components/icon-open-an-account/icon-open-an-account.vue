...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-open-an-account", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-open-an-account;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-open-an-account;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-open-an-account;}
	/* #endif */
