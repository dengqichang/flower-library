...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-razor",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-razor;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-razor;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-razor;}
	/* #endif */
