<template>
	<text :class="['fr-icon-lip-tattoo',`fr-icon__${type}`]" :style="[iconStyle]">{{showIcon}}</text>
</template>
<!-- #ifdef VUE3 -->
<script lang="uts">
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');
	domModule.addRule('fontFace', { 'fontFamily': 'icon-lip-tattoo', 'src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-lip-tattoo.ttf")}')` });
	// #endif
...
<script>
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': 'icon-lip-tattoo','src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-lip-tattoo.ttf")}')`});
	// #endif
...
<style lang="scss">
	...
	@font-face {font-family: "icon-lip-tattoo";src: url('/static/iconfont/icon-lip-tattoo.ttf');}
	/* #endif */
	.fr-icon-lip-tattoo {font-family: icon-lip-tattoo;}
</style>