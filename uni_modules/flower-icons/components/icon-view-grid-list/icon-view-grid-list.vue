...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-view-grid-list", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-view-grid-list;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-view-grid-list;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-view-grid-list;}
	/* #endif */
