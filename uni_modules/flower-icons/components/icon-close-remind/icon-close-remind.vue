...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-close-remind", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-close-remind;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-close-remind;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-close-remind;}
	/* #endif */
