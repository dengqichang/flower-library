...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-folder-lock", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-folder-lock;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-folder-lock;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-folder-lock;}
	/* #endif */
