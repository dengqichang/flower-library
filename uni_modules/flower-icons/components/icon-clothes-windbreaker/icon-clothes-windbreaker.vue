...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-clothes-windbreaker", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-clothes-windbreaker;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-clothes-windbreaker;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-clothes-windbreaker;}
	/* #endif */
