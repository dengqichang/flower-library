...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-alignment-left-top",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-alignment-left-top;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-alignment-left-top;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-alignment-left-top;}
	/* #endif */
