...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-quadrilateral", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-quadrilateral;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-quadrilateral;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-quadrilateral;}
	/* #endif */
