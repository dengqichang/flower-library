...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-engineering-vehicle", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-engineering-vehicle;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-engineering-vehicle;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-engineering-vehicle;}
	/* #endif */
