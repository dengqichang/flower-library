...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-shopping-mall", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-shopping-mall;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-shopping-mall;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-shopping-mall;}
	/* #endif */
