...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-connection-arrow", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-connection-arrow;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-connection-arrow;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-connection-arrow;}
	/* #endif */
