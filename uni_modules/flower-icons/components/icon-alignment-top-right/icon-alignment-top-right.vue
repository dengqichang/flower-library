...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-alignment-top-right", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-alignment-top-right;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-alignment-top-right;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-alignment-top-right;}
	/* #endif */
