...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-hourglass-full", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-hourglass-full;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-hourglass-full;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-hourglass-full;}
	/* #endif */
