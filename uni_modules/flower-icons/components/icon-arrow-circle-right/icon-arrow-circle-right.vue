...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-arrow-circle-right",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-arrow-circle-right;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-arrow-circle-right;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-arrow-circle-right;}
	/* #endif */
