...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-h3",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-h3;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-h3;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-h3;}
	/* #endif */
