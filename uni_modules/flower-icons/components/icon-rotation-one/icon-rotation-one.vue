...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-rotation-one",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-rotation-one;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-rotation-one;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-rotation-one;}
	/* #endif */
