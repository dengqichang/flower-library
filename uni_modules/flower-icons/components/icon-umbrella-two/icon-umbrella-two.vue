...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-umbrella-two", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-umbrella-two;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-umbrella-two;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-umbrella-two;}
	/* #endif */
