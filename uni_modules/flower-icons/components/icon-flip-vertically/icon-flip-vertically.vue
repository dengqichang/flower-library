...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-flip-vertically",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-flip-vertically;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-flip-vertically;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-flip-vertically;}
	/* #endif */
