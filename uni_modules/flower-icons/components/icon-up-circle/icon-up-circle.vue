...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-up-circle", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-up-circle;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-up-circle;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-up-circle;}
	/* #endif */
