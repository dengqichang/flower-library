...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-difference-set",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-difference-set;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-difference-set;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-difference-set;}
	/* #endif */
