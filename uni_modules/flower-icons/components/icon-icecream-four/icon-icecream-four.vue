<template>
	<text :class="['fr-icon-icecream-four',`fr-icon__${type}`]" :style="[iconStyle]">{{showIcon}}</text>
</template>
<!-- #ifdef VUE3 -->
<script lang="uts">
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');
	domModule.addRule('fontFace', { 'fontFamily': 'icon-icecream-four', 'src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-icecream-four.ttf")}')` });
	// #endif
...
<script>
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': 'icon-icecream-four','src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-icecream-four.ttf")}')`});
	// #endif
...
<style lang="scss">
	...
	@font-face {font-family: "icon-icecream-four";src: url('/static/iconfont/icon-icecream-four.ttf');}
	/* #endif */
	.fr-icon-icecream-four {font-family: icon-icecream-four;}
</style>