...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-send-to-back", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-send-to-back;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-send-to-back;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-send-to-back;}
	/* #endif */
