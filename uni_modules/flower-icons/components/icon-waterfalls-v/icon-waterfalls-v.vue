...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-waterfalls-v",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-waterfalls-v;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-waterfalls-v;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-waterfalls-v;}
	/* #endif */
