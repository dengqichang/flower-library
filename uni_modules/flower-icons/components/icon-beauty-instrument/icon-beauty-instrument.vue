...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-beauty-instrument", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-beauty-instrument;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-beauty-instrument;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-beauty-instrument;}
	/* #endif */
