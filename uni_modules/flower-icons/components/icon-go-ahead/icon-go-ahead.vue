...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-go-ahead", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-go-ahead;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-go-ahead;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-go-ahead;}
	/* #endif */
