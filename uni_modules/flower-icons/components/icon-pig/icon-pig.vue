...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-pig",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-pig;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-pig;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-pig;}
	/* #endif */
