...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-dome",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-dome;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-dome;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-dome;}
	/* #endif */
