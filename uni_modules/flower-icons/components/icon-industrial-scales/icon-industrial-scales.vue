...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-industrial-scales", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-industrial-scales;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-industrial-scales;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-industrial-scales;}
	/* #endif */
