<template>
	<text :class="['fr-icon-doc-search',`fr-icon__${type}`]" :style="[iconStyle]">{{showIcon}}</text>
</template>
<!-- #ifdef VUE3 -->
<script lang="uts">
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');
	domModule.addRule('fontFace', { 'fontFamily': 'icon-doc-search', 'src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-doc-search.ttf")}')` });
	// #endif
...
<script>
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': 'icon-doc-search','src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-doc-search.ttf")}')`});
	// #endif
...
<style lang="scss">
	...
	@font-face {font-family: "icon-doc-search";src: url('/static/iconfont/icon-doc-search.ttf');}
	/* #endif */
	.fr-icon-doc-search {font-family: icon-doc-search;}
</style>