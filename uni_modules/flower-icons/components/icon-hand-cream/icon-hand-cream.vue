...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-hand-cream",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-hand-cream;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-hand-cream;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-hand-cream;}
	/* #endif */
