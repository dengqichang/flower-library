...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-water-rate-one", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-water-rate-one;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-water-rate-one;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-water-rate-one;}
	/* #endif */
