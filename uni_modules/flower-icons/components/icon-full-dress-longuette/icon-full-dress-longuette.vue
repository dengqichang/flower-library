...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-full-dress-longuette", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-full-dress-longuette;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-full-dress-longuette;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-full-dress-longuette;}
	/* #endif */
