...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-align-text-both",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-align-text-both;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-align-text-both;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-align-text-both;}
	/* #endif */
