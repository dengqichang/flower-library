...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-record-disc", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-record-disc;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-record-disc;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-record-disc;}
	/* #endif */
