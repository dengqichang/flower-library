...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-grid-three", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-grid-three;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-grid-three;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-grid-three;}
	/* #endif */
