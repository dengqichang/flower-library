...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-left-circle", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-left-circle;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-left-circle;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-left-circle;}
	/* #endif */
