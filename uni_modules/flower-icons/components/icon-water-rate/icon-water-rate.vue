...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-water-rate",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-water-rate;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-water-rate;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-water-rate;}
	/* #endif */
