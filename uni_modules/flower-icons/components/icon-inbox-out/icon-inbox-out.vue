...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-inbox-out", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-inbox-out;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-inbox-out;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-inbox-out;}
	/* #endif */
