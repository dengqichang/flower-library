...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-right-expand",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-right-expand;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-right-expand;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-right-expand;}
	/* #endif */
