<template>
	<text :class="['fr-icon-neutral-face',`fr-icon__${type}`]" :style="[iconStyle]">{{showIcon}}</text>
</template>
<!-- #ifdef VUE3 -->
<script lang="uts">
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');
	domModule.addRule('fontFace', { 'fontFamily': 'icon-neutral-face', 'src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-neutral-face.ttf")}')` });
	// #endif
...
<script>
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': 'icon-neutral-face','src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-neutral-face.ttf")}')`});
	// #endif
...
<style lang="scss">
	...
	@font-face {font-family: "icon-neutral-face";src: url('/static/iconfont/icon-neutral-face.ttf');}
	/* #endif */
	.fr-icon-neutral-face {font-family: icon-neutral-face;}
</style>