...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-parallel-gateway", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-parallel-gateway;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-parallel-gateway;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-parallel-gateway;}
	/* #endif */
