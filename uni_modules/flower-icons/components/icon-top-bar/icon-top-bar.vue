...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-top-bar",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-top-bar;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-top-bar;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-top-bar;}
	/* #endif */
