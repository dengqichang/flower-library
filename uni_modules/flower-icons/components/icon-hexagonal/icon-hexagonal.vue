...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-hexagonal",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-hexagonal;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-hexagonal;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-hexagonal;}
	/* #endif */
