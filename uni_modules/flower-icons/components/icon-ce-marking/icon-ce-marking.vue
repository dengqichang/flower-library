...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-ce-marking", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-ce-marking;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-ce-marking;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-ce-marking;}
	/* #endif */
