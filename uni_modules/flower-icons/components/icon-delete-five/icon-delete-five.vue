...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-delete-five", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-delete-five;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-delete-five;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-delete-five;}
	/* #endif */
