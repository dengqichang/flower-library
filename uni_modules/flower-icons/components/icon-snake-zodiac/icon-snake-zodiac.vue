<template>
	<text :class="['fr-icon-snake-zodiac',`fr-icon__${type}`]" :style="[iconStyle]">{{showIcon}}</text>
</template>
<!-- #ifdef VUE3 -->
<script lang="uts">
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');
	domModule.addRule('fontFace', { 'fontFamily': 'icon-snake-zodiac', 'src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-snake-zodiac.ttf")}')` });
	// #endif
...
<script>
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': 'icon-snake-zodiac','src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-snake-zodiac.ttf")}')`});
	// #endif
...
<style lang="scss">
	...
	@font-face {font-family: "icon-snake-zodiac";src: url('/static/iconfont/icon-snake-zodiac.ttf');}
	/* #endif */
	.fr-icon-snake-zodiac {font-family: icon-snake-zodiac;}
</style>