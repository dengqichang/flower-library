...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-hand-washing-fluid",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-hand-washing-fluid;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-hand-washing-fluid;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-hand-washing-fluid;}
	/* #endif */
