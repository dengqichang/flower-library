...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-taj-mahal", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-taj-mahal;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-taj-mahal;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-taj-mahal;}
	/* #endif */
