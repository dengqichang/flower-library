...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-doc-detail", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-doc-detail;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-doc-detail;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-doc-detail;}
	/* #endif */
