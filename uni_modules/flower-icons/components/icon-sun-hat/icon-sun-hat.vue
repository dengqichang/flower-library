...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-sun-hat", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-sun-hat;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-sun-hat;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-sun-hat;}
	/* #endif */
