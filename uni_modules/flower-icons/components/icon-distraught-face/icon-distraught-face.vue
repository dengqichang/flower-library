...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-distraught-face", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-distraught-face;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-distraught-face;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-distraught-face;}
	/* #endif */
