...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-paragraph-break-two", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-paragraph-break-two;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-paragraph-break-two;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-paragraph-break-two;}
	/* #endif */
