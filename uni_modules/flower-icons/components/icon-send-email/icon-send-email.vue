...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-send-email",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-send-email;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-send-email;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-send-email;}
	/* #endif */
