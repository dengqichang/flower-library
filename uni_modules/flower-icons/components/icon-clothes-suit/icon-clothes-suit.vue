...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-clothes-suit", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-clothes-suit;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-clothes-suit;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-clothes-suit;}
	/* #endif */
