...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-format-brush",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-format-brush;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-format-brush;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-format-brush;}
	/* #endif */
