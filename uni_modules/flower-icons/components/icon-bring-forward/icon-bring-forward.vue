...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-bring-forward",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-bring-forward;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-bring-forward;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-bring-forward;}
	/* #endif */
