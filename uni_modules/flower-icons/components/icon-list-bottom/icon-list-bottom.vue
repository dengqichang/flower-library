...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-list-bottom", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-list-bottom;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-list-bottom;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-list-bottom;}
	/* #endif */
