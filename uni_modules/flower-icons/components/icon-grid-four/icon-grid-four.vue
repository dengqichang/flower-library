...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-grid-four", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-grid-four;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-grid-four;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-grid-four;}
	/* #endif */
