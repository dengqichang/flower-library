...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-drop-shadow-left", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-drop-shadow-left;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-drop-shadow-left;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-drop-shadow-left;}
	/* #endif */
