...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-right-small-up", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-right-small-up;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-right-small-up;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-right-small-up;}
	/* #endif */
