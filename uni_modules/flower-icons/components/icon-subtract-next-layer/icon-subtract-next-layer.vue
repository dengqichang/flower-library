...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-subtract-next-layer", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-subtract-next-layer;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-subtract-next-layer;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-subtract-next-layer;}
	/* #endif */
