...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-multilayer-sphere", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-multilayer-sphere;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-multilayer-sphere;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-multilayer-sphere;}
	/* #endif */
