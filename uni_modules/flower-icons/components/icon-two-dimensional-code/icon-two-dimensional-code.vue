...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-two-dimensional-code", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-two-dimensional-code;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-two-dimensional-code;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-two-dimensional-code;}
	/* #endif */
