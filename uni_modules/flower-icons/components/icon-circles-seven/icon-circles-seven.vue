...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-circles-seven", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-circles-seven;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-circles-seven;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-circles-seven;}
	/* #endif */
