...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-down-picture", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-down-picture;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-down-picture;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-down-picture;}
	/* #endif */
