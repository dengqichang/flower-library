...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-internal-reduction", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-internal-reduction;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-internal-reduction;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-internal-reduction;}
	/* #endif */
