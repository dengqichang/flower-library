...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-barber-clippers",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-barber-clippers;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-barber-clippers;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-barber-clippers;}
	/* #endif */
