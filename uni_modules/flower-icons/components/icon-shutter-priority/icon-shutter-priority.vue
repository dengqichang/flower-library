...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-shutter-priority",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-shutter-priority;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-shutter-priority;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-shutter-priority;}
	/* #endif */
