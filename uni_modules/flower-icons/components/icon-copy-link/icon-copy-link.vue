...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-copy-link", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-copy-link;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-copy-link;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-copy-link;}
	/* #endif */
