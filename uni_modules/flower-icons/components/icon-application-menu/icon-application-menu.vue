...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-application-menu", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-application-menu;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-application-menu;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-application-menu;}
	/* #endif */
