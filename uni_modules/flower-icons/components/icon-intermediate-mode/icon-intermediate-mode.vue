...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-intermediate-mode",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-intermediate-mode;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-intermediate-mode;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-intermediate-mode;}
	/* #endif */
