...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-view-grid-detail",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-view-grid-detail;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-view-grid-detail;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-view-grid-detail;}
	/* #endif */
