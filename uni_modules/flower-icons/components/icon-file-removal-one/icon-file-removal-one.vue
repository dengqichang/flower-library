...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-file-removal-one", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-file-removal-one;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-file-removal-one;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-file-removal-one;}
	/* #endif */
