...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-distribute-horizontally", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-distribute-horizontally;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-distribute-horizontally;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-distribute-horizontally;}
	/* #endif */
