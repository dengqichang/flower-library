...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-rectangle-small", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-rectangle-small;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-rectangle-small;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-rectangle-small;}
	/* #endif */
