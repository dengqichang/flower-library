...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-text-wrap-overflow",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-text-wrap-overflow;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-text-wrap-overflow;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-text-wrap-overflow;}
	/* #endif */
