...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-cones",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-cones;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-cones;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-cones;}
	/* #endif */
