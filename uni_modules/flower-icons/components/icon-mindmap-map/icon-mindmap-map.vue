...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-mindmap-map", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-mindmap-map;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-mindmap-map;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-mindmap-map;}
	/* #endif */
