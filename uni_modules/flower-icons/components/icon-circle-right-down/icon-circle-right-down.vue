...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-circle-right-down", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-circle-right-down;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-circle-right-down;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-circle-right-down;}
	/* #endif */
