...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-foundation-makeup", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-foundation-makeup;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-foundation-makeup;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-foundation-makeup;}
	/* #endif */
