...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-dividing-line", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-dividing-line;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-dividing-line;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-dividing-line;}
	/* #endif */
