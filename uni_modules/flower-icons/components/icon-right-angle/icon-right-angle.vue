...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-right-angle", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-right-angle;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-right-angle;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-right-angle;}
	/* #endif */
