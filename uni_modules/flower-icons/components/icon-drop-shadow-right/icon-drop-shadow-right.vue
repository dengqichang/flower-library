...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-drop-shadow-right", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-drop-shadow-right;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-drop-shadow-right;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-drop-shadow-right;}
	/* #endif */
