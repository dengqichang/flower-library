...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-arch-triomphe", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-arch-triomphe;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-arch-triomphe;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-arch-triomphe;}
	/* #endif */
