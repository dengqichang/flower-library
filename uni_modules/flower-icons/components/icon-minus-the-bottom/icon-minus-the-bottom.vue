...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-minus-the-bottom", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-minus-the-bottom;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-minus-the-bottom;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-minus-the-bottom;}
	/* #endif */
