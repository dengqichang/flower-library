...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-deeplink", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-deeplink;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-deeplink;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-deeplink;}
	/* #endif */
