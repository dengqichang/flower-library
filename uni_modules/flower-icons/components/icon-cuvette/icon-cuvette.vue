...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-cuvette", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-cuvette;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-cuvette;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-cuvette;}
	/* #endif */
