...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-adjacent-item", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-adjacent-item;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-adjacent-item;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-adjacent-item;}
	/* #endif */
