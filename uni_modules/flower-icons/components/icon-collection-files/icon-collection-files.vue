...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-collection-files", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-collection-files;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-collection-files;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-collection-files;}
	/* #endif */
