...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-demo", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-demo;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-demo;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-demo;}
	/* #endif */
