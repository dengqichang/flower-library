...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-demo;src: url('iconfont.ttf') format('truetype');}.flower-icons {font-family: flower-demo;font-size: 28rpx;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-demo;font-size: 28rpx;}
	/* #endif */
</style>
