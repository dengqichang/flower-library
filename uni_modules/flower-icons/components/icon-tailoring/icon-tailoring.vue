...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-tailoring", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-tailoring;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-tailoring;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-tailoring;}
	/* #endif */
