...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-bell-ring", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-bell-ring;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-bell-ring;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-bell-ring;}
	/* #endif */
