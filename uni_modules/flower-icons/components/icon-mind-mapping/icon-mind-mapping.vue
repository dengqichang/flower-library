...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-mind-mapping", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-mind-mapping;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-mind-mapping;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-mind-mapping;}
	/* #endif */
