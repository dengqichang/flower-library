...
<script setup>
	// #ifdef APP-NVUE
	import iconUrl from './iconfont.ttf';const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': "flower-icon-exchange-three",'src': "url('" + iconUrl + "')"});
	// #endif
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-exchange-three;src: url('iconfont.ttf') format('truetype');}.flower-icons {font-family: flower-icon-exchange-three;font-size: 28rpx;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-exchange-three;font-size: 28rpx;}
	/* #endif */
</style>
