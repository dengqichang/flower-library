...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-round-caliper", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-round-caliper;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-round-caliper;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-round-caliper;}
	/* #endif */
