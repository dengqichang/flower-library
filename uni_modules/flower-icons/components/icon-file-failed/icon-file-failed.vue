...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-file-failed",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-file-failed;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-file-failed;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-file-failed;}
	/* #endif */
