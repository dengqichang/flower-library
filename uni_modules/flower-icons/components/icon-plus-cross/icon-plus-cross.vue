...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-plus-cross", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-plus-cross;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-plus-cross;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-plus-cross;}
	/* #endif */
