...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-direction-adjustment-two",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-direction-adjustment-two;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-direction-adjustment-two;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-direction-adjustment-two;}
	/* #endif */
