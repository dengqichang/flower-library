...
<script>
	// #ifdef APP-NVUE
	import iconUrl from './iconfont.ttf';const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': "flower-icon-pic",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
...
<style scoped>
	...
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-pic;font-size: 28rpx;}
	/* #endif */
</style>
