...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-alignment-bottom-right", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-alignment-bottom-right;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-alignment-bottom-right;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-alignment-bottom-right;}
	/* #endif */
