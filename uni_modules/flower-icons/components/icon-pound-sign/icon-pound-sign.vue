...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-pound-sign", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-pound-sign;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-pound-sign;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-pound-sign;}
	/* #endif */
