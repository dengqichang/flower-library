...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-inner-shadow-top-left", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-inner-shadow-top-left;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-inner-shadow-top-left;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-inner-shadow-top-left;}
	/* #endif */
