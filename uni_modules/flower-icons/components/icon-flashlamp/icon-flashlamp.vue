...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-flashlamp", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-flashlamp;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-flashlamp;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-flashlamp;}
	/* #endif */
