...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-screenshot-two", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-screenshot-two;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-screenshot-two;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-screenshot-two;}
	/* #endif */
