...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-corner-left-down", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-corner-left-down;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-corner-left-down;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-corner-left-down;}
	/* #endif */
