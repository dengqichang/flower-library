...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-hourglass-null", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-hourglass-null;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-hourglass-null;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-hourglass-null;}
	/* #endif */
