...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-commodity",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-commodity;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-commodity;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-commodity;}
	/* #endif */
