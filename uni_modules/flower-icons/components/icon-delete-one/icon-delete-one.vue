<template>
	<text :class="['fr-icon-delete-one',`fr-icon__${type}`]" :style="[iconStyle]">{{showIcon}}</text>
</template>
<!-- #ifdef VUE3 -->
<script lang="uts">
	// #ifdef APP-PLUS-NVUE
...
<style lang="scss">
	...
	@font-face {font-family: "icon-delete-one";src: url('/static/iconfont/icon-delete-one.ttf');}
	/* #endif */
	.fr-icon-delete-one {font-family: icon-delete-one;}
</style>