...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-menu-fold", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-menu-fold;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-menu-fold;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-menu-fold;}
	/* #endif */
