...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-figma-component", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-figma-component;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-figma-component;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-figma-component;}
	/* #endif */
