...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-sort-amount-up", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-sort-amount-up;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-sort-amount-up;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-sort-amount-up;}
	/* #endif */
