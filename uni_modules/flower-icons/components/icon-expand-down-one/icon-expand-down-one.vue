...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-expand-down-one", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-expand-down-one;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-expand-down-one;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-expand-down-one;}
	/* #endif */
