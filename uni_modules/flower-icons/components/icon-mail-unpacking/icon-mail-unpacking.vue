...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-mail-unpacking", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-mail-unpacking;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-mail-unpacking;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-mail-unpacking;}
	/* #endif */
