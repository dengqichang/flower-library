...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-keyline",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-keyline;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-keyline;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-keyline;}
	/* #endif */
