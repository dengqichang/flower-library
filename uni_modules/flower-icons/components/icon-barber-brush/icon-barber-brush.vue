...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-barber-brush", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-barber-brush;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-barber-brush;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-barber-brush;}
	/* #endif */
