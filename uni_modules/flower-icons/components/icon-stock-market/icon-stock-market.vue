...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-stock-market", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-stock-market;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-stock-market;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-stock-market;}
	/* #endif */
