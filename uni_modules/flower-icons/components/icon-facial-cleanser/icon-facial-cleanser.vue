...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-facial-cleanser", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-facial-cleanser;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-facial-cleanser;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-facial-cleanser;}
	/* #endif */
