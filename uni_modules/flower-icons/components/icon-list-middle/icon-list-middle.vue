...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-list-middle",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-list-middle;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-list-middle;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-list-middle;}
	/* #endif */
