...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-intersect-selection", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-intersect-selection;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-intersect-selection;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-intersect-selection;}
	/* #endif */
