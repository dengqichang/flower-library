...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-all-application",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-all-application;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-all-application;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-all-application;}
	/* #endif */
