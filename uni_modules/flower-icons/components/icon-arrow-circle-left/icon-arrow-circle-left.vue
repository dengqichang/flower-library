...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-arrow-circle-left", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-arrow-circle-left;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-arrow-circle-left;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-arrow-circle-left;}
	/* #endif */
