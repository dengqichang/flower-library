...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-resistor",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-resistor;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-resistor;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-resistor;}
	/* #endif */
