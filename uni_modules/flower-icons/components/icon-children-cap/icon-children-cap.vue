...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-children-cap",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-children-cap;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-children-cap;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-children-cap;}
	/* #endif */
