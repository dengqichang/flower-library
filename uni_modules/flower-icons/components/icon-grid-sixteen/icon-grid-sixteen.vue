...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-grid-sixteen",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-grid-sixteen;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-grid-sixteen;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-grid-sixteen;}
	/* #endif */
