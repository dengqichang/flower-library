...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-reverse-operation-in", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-reverse-operation-in;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-reverse-operation-in;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-reverse-operation-in;}
	/* #endif */
