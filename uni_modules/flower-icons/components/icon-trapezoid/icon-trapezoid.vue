...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-trapezoid",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-trapezoid;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-trapezoid;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-trapezoid;}
	/* #endif */
