...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-clothes-gloves", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-clothes-gloves;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-clothes-gloves;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-clothes-gloves;}
	/* #endif */
