...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-eiffel-tower", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-eiffel-tower;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-eiffel-tower;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-eiffel-tower;}
	/* #endif */
