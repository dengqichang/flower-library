...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-text-rotation-up",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-text-rotation-up;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-text-rotation-up;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-text-rotation-up;}
	/* #endif */
