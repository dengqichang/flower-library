...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-enter-the-keyboard", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-enter-the-keyboard;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-enter-the-keyboard;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-enter-the-keyboard;}
	/* #endif */
