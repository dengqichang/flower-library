...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-cosmetic-brush", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-cosmetic-brush;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-cosmetic-brush;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-cosmetic-brush;}
	/* #endif */
