...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-send-backward",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-send-backward;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-send-backward;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-send-backward;}
	/* #endif */
