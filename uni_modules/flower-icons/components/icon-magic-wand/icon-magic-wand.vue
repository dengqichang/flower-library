...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-magic-wand",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-magic-wand;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-magic-wand;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-magic-wand;}
	/* #endif */
