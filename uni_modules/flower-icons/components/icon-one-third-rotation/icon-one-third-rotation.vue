...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-one-third-rotation", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-one-third-rotation;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-one-third-rotation;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-one-third-rotation;}
	/* #endif */
