...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-petrol",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-petrol;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-petrol;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-petrol;}
	/* #endif */
