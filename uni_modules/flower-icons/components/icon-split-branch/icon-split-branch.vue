...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-split-branch", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-split-branch;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-split-branch;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-split-branch;}
	/* #endif */
