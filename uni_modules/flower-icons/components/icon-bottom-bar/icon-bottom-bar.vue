...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-bottom-bar", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-bottom-bar;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-bottom-bar;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-bottom-bar;}
	/* #endif */
