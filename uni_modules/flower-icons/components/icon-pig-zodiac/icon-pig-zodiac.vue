...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-pig-zodiac", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-pig-zodiac;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-pig-zodiac;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-pig-zodiac;}
	/* #endif */
