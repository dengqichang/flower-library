...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-bring-to-front", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-bring-to-front;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-bring-to-front;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-bring-to-front;}
	/* #endif */
