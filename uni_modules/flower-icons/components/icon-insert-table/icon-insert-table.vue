...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-insert-table",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-insert-table;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-insert-table;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-insert-table;}
	/* #endif */
