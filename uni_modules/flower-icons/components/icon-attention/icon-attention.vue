...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-attention",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-attention;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-attention;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-attention;}
	/* #endif */
