...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-tape-measure", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-tape-measure;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-tape-measure;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-tape-measure;}
	/* #endif */
