...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-outbound",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-outbound;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-outbound;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-outbound;}
	/* #endif */
