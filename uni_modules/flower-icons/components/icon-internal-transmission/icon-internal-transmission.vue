...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-internal-transmission", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-internal-transmission;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-internal-transmission;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-internal-transmission;}
	/* #endif */
