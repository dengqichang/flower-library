...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-paperclip", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-paperclip;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-paperclip;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-paperclip;}
	/* #endif */
