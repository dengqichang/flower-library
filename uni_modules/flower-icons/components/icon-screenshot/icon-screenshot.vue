...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-screenshot", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-screenshot;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-screenshot;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-screenshot;}
	/* #endif */
