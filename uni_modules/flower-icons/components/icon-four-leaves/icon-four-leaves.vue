...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-four-leaves", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-four-leaves;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-four-leaves;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-four-leaves;}
	/* #endif */
