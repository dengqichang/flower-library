...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-game-emoji", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-game-emoji;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-game-emoji;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-game-emoji;}
	/* #endif */
