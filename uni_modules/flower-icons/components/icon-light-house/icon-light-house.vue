...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-light-house",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-light-house;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-light-house;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-light-house;}
	/* #endif */
