...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-triangle",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-triangle;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-triangle;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-triangle;}
	/* #endif */
