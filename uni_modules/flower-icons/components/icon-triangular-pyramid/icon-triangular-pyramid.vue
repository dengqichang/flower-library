...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-triangular-pyramid", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-triangular-pyramid;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-triangular-pyramid;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-triangular-pyramid;}
	/* #endif */
