...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-upload-picture", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-upload-picture;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-upload-picture;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-upload-picture;}
	/* #endif */
