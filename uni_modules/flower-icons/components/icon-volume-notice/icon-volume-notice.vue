...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-volume-notice",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-volume-notice;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-volume-notice;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-volume-notice;}
	/* #endif */
