...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-imbalance", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-imbalance;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-imbalance;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-imbalance;}
	/* #endif */
