...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-four-point-connection",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-four-point-connection;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-four-point-connection;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-four-point-connection;}
	/* #endif */
