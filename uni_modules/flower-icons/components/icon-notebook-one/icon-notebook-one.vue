...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-notebook-one", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-notebook-one;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-notebook-one;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-notebook-one;}
	/* #endif */
