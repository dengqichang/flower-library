...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-pentagon", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-pentagon;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-pentagon;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-pentagon;}
	/* #endif */
