...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-nine-points-connected",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-nine-points-connected;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-nine-points-connected;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-nine-points-connected;}
	/* #endif */
