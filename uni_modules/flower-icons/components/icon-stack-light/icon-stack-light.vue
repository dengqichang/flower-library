...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-stack-light", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-stack-light;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-stack-light;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-stack-light;}
	/* #endif */
