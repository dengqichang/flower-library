...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-date-comes-back",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-date-comes-back;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-date-comes-back;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-date-comes-back;}
	/* #endif */
