...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-rss",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-rss;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-rss;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-rss;}
	/* #endif */
