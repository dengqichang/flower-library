...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-butterfly", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-butterfly;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-butterfly;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-butterfly;}
	/* #endif */
