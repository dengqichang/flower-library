...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-whirlwind", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-whirlwind;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-whirlwind;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-whirlwind;}
	/* #endif */
