...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-ppt",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-ppt;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-ppt;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-ppt;}
	/* #endif */
