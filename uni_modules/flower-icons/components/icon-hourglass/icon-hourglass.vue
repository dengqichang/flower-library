...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-hourglass", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-hourglass;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-hourglass;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-hourglass;}
	/* #endif */
