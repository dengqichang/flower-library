<template>
	<text :class="['fr-icon-cattle-zodiac',`fr-icon__${type}`]" :style="[iconStyle]">{{showIcon}}</text>
</template>
<!-- #ifdef VUE3 -->
<script lang="uts">
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');
	domModule.addRule('fontFace', { 'fontFamily': 'icon-cattle-zodiac', 'src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-cattle-zodiac.ttf")}')` });
	// #endif
...
<script>
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': 'icon-cattle-zodiac','src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-cattle-zodiac.ttf")}')`});
	// #endif
...
<style lang="scss">
	...
	@font-face {font-family: "icon-cattle-zodiac";src: url('/static/iconfont/icon-cattle-zodiac.ttf');}
	/* #endif */
	.fr-icon-cattle-zodiac {font-family: icon-cattle-zodiac;}
</style>