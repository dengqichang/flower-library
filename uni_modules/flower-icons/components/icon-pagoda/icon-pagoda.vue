...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-pagoda", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-pagoda;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-pagoda;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-pagoda;}
	/* #endif */
