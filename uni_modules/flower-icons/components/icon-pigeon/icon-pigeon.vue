...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-pigeon", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-pigeon;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-pigeon;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-pigeon;}
	/* #endif */
