...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-rotation-vertical",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-rotation-vertical;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-rotation-vertical;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-rotation-vertical;}
	/* #endif */
