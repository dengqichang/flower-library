...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-treasure-chest", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-treasure-chest;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-treasure-chest;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-treasure-chest;}
	/* #endif */
