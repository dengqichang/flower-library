...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-corner-up-left", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-corner-up-left;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-corner-up-left;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-corner-up-left;}
	/* #endif */
