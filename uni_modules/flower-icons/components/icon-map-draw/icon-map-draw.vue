...
<script>
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': 'icon-map-draw','src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-map-draw.ttf")}')`});
	// #endif
