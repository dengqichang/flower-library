...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-layout-four",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-layout-four;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-layout-four;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-layout-four;}
	/* #endif */
