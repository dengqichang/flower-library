...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-overall-reduction", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-overall-reduction;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-overall-reduction;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-overall-reduction;}
	/* #endif */
