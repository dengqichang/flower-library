...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-paper-money-one", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-paper-money-one;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-paper-money-one;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-paper-money-one;}
	/* #endif */
