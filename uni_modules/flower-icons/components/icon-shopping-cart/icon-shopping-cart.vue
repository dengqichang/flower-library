...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-shopping-cart", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-shopping-cart;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-shopping-cart;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-shopping-cart;}
	/* #endif */
