...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-inner-shadow-up",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-inner-shadow-up;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-inner-shadow-up;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-inner-shadow-up;}
	/* #endif */
