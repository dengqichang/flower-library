...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-right-bar", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-right-bar;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-right-bar;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-right-bar;}
	/* #endif */
