...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-folder-minus", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-folder-minus;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-folder-minus;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-folder-minus;}
	/* #endif */
