...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-picture-album", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-picture-album;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-picture-album;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-picture-album;}
	/* #endif */
