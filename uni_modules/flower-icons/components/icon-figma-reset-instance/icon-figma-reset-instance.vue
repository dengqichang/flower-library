...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-figma-reset-instance", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-figma-reset-instance;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-figma-reset-instance;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-figma-reset-instance;}
	/* #endif */
