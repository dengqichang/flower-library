...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-exclusive-gateway", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-exclusive-gateway;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-exclusive-gateway;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-exclusive-gateway;}
	/* #endif */
