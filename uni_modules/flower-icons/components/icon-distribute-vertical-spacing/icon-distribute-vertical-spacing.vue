...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-distribute-vertical-spacing", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-distribute-vertical-spacing;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-distribute-vertical-spacing;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-distribute-vertical-spacing;}
	/* #endif */
