...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-parallelogram", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-parallelogram;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-parallelogram;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-parallelogram;}
	/* #endif */
