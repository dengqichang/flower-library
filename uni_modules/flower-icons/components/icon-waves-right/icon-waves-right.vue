...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-waves-right", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-waves-right;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-waves-right;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-waves-right;}
	/* #endif */
