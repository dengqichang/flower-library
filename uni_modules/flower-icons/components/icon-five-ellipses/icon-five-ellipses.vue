...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-five-ellipses", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-five-ellipses;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-five-ellipses;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-five-ellipses;}
	/* #endif */
