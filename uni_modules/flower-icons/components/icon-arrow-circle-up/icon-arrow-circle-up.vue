...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-arrow-circle-up", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-arrow-circle-up;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-arrow-circle-up;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-arrow-circle-up;}
	/* #endif */
