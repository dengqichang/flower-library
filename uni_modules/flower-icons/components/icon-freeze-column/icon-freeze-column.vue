...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-freeze-column",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-freeze-column;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-freeze-column;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-freeze-column;}
	/* #endif */
