...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-click-fold", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-click-fold;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-click-fold;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-click-fold;}
	/* #endif */
