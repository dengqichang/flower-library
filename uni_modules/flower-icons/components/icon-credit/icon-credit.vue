...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-credit",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-credit;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-credit;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-credit;}
	/* #endif */
