...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-error-prompt",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-error-prompt;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-error-prompt;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-error-prompt;}
	/* #endif */
