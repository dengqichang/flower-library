...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-list",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-list;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-list;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-list;}
	/* #endif */
