...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-freezing-line-column",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-freezing-line-column;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-freezing-line-column;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-freezing-line-column;}
	/* #endif */
