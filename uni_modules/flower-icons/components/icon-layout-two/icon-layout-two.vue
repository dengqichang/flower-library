...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-layout-two", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-layout-two;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-layout-two;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-layout-two;}
	/* #endif */
