...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-ios-face-recognition",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-ios-face-recognition;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-ios-face-recognition;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-ios-face-recognition;}
	/* #endif */
