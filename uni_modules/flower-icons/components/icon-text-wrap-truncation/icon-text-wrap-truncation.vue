...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-text-wrap-truncation", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-text-wrap-truncation;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-text-wrap-truncation;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-text-wrap-truncation;}
	/* #endif */
