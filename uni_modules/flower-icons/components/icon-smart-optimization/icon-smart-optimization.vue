...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-smart-optimization", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-smart-optimization;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-smart-optimization;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-smart-optimization;}
	/* #endif */
