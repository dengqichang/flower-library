...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-zoom-out",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-zoom-out;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-zoom-out;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-zoom-out;}
	/* #endif */
