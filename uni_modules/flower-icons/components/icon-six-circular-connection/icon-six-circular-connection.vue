...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-six-circular-connection", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-six-circular-connection;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-six-circular-connection;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-six-circular-connection;}
	/* #endif */
