...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-red-envelope", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-red-envelope;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-red-envelope;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-red-envelope;}
	/* #endif */
