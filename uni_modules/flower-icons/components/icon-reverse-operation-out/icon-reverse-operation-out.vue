...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-reverse-operation-out",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-reverse-operation-out;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-reverse-operation-out;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-reverse-operation-out;}
	/* #endif */
