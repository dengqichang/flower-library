...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-fold-up-one", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-fold-up-one;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-fold-up-one;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-fold-up-one;}
	/* #endif */
