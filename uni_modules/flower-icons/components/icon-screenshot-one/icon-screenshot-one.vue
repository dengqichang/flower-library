...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-screenshot-one", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-screenshot-one;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-screenshot-one;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-screenshot-one;}
	/* #endif */
