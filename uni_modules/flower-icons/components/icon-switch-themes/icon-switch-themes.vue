...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-switch-themes",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-switch-themes;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-switch-themes;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-switch-themes;}
	/* #endif */
