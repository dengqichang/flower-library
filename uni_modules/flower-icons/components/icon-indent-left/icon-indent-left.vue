...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-indent-left", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-indent-left;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-indent-left;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-indent-left;}
	/* #endif */
