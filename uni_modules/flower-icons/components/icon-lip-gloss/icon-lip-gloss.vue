...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-lip-gloss", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-lip-gloss;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-lip-gloss;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-lip-gloss;}
	/* #endif */
