...
<script>
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': 'icon-write','src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-write.ttf")}')`});
	// #endif
