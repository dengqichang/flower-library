...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-space-colony", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-space-colony;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-space-colony;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-space-colony;}
	/* #endif */
