...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-proportional-scaling", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-proportional-scaling;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-proportional-scaling;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-proportional-scaling;}
	/* #endif */
