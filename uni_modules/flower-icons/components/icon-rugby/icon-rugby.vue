...
<script>
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': 'icon-rugby','src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-rugby.ttf")}')`});
	// #endif
