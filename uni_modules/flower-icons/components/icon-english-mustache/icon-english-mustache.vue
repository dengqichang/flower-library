...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-english-mustache", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-english-mustache;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-english-mustache;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-english-mustache;}
	/* #endif */
