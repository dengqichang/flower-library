...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-weary-face", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-weary-face;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-weary-face;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-weary-face;}
	/* #endif */
