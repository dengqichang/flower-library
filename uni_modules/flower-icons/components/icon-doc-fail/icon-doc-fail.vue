...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-doc-fail", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-doc-fail;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-doc-fail;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-doc-fail;}
	/* #endif */
