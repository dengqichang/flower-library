...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-perfumer-bottle",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-perfumer-bottle;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-perfumer-bottle;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-perfumer-bottle;}
	/* #endif */
