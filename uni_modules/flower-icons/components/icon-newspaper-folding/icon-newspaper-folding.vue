...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-newspaper-folding", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-newspaper-folding;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-newspaper-folding;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-newspaper-folding;}
	/* #endif */
