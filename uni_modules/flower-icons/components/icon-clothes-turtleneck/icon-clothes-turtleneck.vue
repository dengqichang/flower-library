...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-clothes-turtleneck", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-clothes-turtleneck;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-clothes-turtleneck;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-clothes-turtleneck;}
	/* #endif */
