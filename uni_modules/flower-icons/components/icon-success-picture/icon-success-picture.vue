...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-success-picture", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-success-picture;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-success-picture;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-success-picture;}
	/* #endif */
