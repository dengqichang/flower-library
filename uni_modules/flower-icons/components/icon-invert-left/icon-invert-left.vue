...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-invert-left",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-invert-left;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-invert-left;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-invert-left;}
	/* #endif */
