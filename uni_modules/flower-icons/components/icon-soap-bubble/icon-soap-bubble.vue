...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-soap-bubble", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-soap-bubble;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-soap-bubble;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-soap-bubble;}
	/* #endif */
