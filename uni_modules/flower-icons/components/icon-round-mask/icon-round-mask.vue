...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-round-mask", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-round-mask;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-round-mask;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-round-mask;}
	/* #endif */
