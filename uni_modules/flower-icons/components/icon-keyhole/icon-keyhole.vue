...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-keyhole", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-keyhole;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-keyhole;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-keyhole;}
	/* #endif */
