...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-play-wrong",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-play-wrong;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-play-wrong;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-play-wrong;}
	/* #endif */
