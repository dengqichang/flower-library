...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-copy",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-copy;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-copy;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-copy;}
	/* #endif */
