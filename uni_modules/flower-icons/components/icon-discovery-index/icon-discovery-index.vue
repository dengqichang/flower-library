...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-discovery-index", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-discovery-index;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-discovery-index;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-discovery-index;}
	/* #endif */
