...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-left-alignment", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-left-alignment;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-left-alignment;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-left-alignment;}
	/* #endif */
