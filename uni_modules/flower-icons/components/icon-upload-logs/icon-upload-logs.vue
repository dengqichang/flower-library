...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-upload-logs",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-upload-logs;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-upload-logs;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-upload-logs;}
	/* #endif */
