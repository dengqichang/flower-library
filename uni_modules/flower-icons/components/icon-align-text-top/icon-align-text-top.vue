...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-align-text-top",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-align-text-top;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-align-text-top;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-align-text-top;}
	/* #endif */
