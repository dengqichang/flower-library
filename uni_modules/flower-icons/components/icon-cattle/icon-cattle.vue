...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-cattle",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-cattle;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-cattle;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-cattle;}
	/* #endif */
