...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-scan-code",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-scan-code;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-scan-code;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-scan-code;}
	/* #endif */
