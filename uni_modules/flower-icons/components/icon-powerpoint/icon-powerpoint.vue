...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-powerpoint", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-powerpoint;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-powerpoint;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-powerpoint;}
	/* #endif */
