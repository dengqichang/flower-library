...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-mail-download",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-mail-download;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-mail-download;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-mail-download;}
	/* #endif */
