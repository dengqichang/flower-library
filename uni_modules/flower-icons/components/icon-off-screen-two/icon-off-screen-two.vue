...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-off-screen-two",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-off-screen-two;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-off-screen-two;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-off-screen-two;}
	/* #endif */
