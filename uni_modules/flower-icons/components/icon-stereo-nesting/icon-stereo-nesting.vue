...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-stereo-nesting", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-stereo-nesting;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-stereo-nesting;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-stereo-nesting;}
	/* #endif */
