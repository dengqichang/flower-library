...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-file-withdrawal", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-file-withdrawal;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-file-withdrawal;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-file-withdrawal;}
	/* #endif */
