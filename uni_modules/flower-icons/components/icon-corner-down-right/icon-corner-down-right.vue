...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-corner-down-right", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-corner-down-right;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-corner-down-right;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-corner-down-right;}
	/* #endif */
