...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-bank-card-two",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-bank-card-two;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-bank-card-two;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-bank-card-two;}
	/* #endif */
