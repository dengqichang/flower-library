...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-invert-camera", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-invert-camera;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-invert-camera;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-invert-camera;}
	/* #endif */
