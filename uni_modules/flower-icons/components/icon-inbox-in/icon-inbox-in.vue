...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-inbox-in", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-inbox-in;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-inbox-in;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-inbox-in;}
	/* #endif */
