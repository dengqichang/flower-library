...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-healthy-recognition", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-healthy-recognition;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-healthy-recognition;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-healthy-recognition;}
	/* #endif */
