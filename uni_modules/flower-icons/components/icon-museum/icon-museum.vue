...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-museum",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-museum;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-museum;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-museum;}
	/* #endif */
