...
<script>
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': 'icon-cooperative-handshake','src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-cooperative-handshake.ttf")}')`});
	// #endif
