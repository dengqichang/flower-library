...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-electric-wave", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-electric-wave;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-electric-wave;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-electric-wave;}
	/* #endif */
