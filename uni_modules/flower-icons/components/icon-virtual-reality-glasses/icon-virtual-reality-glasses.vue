<template>
	<text :class="['fr-icon-virtual-reality-glasses',`fr-icon__${type}`]" :style="[iconStyle]">{{showIcon}}</text>
</template>
<!-- #ifdef VUE3 -->
<script lang="uts">
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');
	domModule.addRule('fontFace', { 'fontFamily': 'icon-virtual-reality-glasses', 'src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-virtual-reality-glasses.ttf")}')` });
	// #endif
...
<script>
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': 'icon-virtual-reality-glasses','src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-virtual-reality-glasses.ttf")}')`});
	// #endif
...
<style lang="scss">
	...
	@font-face {font-family: "icon-virtual-reality-glasses";src: url('/static/iconfont/icon-virtual-reality-glasses.ttf');}
	/* #endif */
	.fr-icon-virtual-reality-glasses {font-family: icon-virtual-reality-glasses;}
</style>