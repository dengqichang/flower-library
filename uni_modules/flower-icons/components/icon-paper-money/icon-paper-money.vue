...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-paper-money", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-paper-money;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-paper-money;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-paper-money;}
	/* #endif */
