...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-backpack",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-backpack;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-backpack;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-backpack;}
	/* #endif */
