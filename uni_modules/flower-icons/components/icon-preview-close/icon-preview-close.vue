...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-preview-close",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-preview-close;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-preview-close;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-preview-close;}
	/* #endif */
