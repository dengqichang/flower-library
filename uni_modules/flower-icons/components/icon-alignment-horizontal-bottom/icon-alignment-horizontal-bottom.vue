...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-alignment-horizontal-bottom",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-alignment-horizontal-bottom;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-alignment-horizontal-bottom;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-alignment-horizontal-bottom;}
	/* #endif */
