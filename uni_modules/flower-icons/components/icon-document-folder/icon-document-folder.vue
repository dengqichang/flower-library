...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-document-folder", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-document-folder;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-document-folder;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-document-folder;}
	/* #endif */
