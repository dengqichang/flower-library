...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-minus",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-minus;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-minus;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-minus;}
	/* #endif */
