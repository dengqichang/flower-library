...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-triangle-round-rectangle", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-triangle-round-rectangle;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-triangle-round-rectangle;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-triangle-round-rectangle;}
	/* #endif */
