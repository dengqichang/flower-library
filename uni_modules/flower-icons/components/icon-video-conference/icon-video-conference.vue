...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-video-conference", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-video-conference;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-video-conference;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-video-conference;}
	/* #endif */
