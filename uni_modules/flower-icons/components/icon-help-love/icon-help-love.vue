<template>
	<text :class="['fr-icon-help-love',`fr-icon__${type}`]" :style="[iconStyle]">{{showIcon}}</text>
</template>
<!-- #ifdef VUE3 -->
<script lang="uts">
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');
	domModule.addRule('fontFace', { 'fontFamily': 'icon-help-love', 'src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-help-love.ttf")}')` });
	// #endif
...
<script>
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': 'icon-help-love','src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-help-love.ttf")}')`});
	// #endif
...
<style lang="scss">
	...
	@font-face {font-family: "icon-help-love";src: url('/static/iconfont/icon-help-love.ttf');}
	/* #endif */
	.fr-icon-help-love {font-family: icon-help-love;}
</style>