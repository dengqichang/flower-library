...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-figma-flatten-selection",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-figma-flatten-selection;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-figma-flatten-selection;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-figma-flatten-selection;}
	/* #endif */
