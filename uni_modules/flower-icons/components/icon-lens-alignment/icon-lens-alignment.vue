...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-lens-alignment", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-lens-alignment;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-lens-alignment;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-lens-alignment;}
	/* #endif */
