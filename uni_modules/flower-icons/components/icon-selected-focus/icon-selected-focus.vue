...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-selected-focus;src: url('iconfont.ttf') format('truetype');}.flower-icons {font-family: flower-icon-selected-focus;font-size: 28rpx;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-selected-focus;font-size: 28rpx;}
	/* #endif */
</style>
