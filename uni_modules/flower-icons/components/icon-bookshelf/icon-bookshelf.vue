...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-bookshelf", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-bookshelf;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-bookshelf;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-bookshelf;}
	/* #endif */
