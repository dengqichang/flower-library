...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-monkey-zodiac", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-monkey-zodiac;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-monkey-zodiac;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-monkey-zodiac;}
	/* #endif */
