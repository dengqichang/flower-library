...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-eyebrow", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-eyebrow;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-eyebrow;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-eyebrow;}
	/* #endif */
