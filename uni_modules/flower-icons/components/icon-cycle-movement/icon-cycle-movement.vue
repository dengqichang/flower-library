...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-cycle-movement", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-cycle-movement;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-cycle-movement;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-cycle-movement;}
	/* #endif */
