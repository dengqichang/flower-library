<template>
	<text :class="['fr-icon-icecream-five',`fr-icon__${type}`]" :style="[iconStyle]">{{showIcon}}</text>
</template>
<!-- #ifdef VUE3 -->
<script lang="uts">
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');
	domModule.addRule('fontFace', { 'fontFamily': 'icon-icecream-five', 'src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-icecream-five.ttf")}')` });
	// #endif
...
<script>
	// #ifdef APP-PLUS-NVUE
	const domModule = weex.requireModule('dom');domModule.addRule('fontFace', {'fontFamily': 'icon-icecream-five','src': `url('file:/${plus.io.convertLocalFileSystemURL("/static/iconfont/icon-icecream-five.ttf")}')`});
	// #endif
...
<style lang="scss">
	...
	@font-face {font-family: "icon-icecream-five";src: url('/static/iconfont/icon-icecream-five.ttf');}
	/* #endif */
	.fr-icon-icecream-five {font-family: icon-icecream-five;}
</style>