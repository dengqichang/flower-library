...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-rectangle-tear", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-rectangle-tear;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-rectangle-tear;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-rectangle-tear;}
	/* #endif */
