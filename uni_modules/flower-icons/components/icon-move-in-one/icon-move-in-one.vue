...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-move-in-one",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-move-in-one;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-move-in-one;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-move-in-one;}
	/* #endif */
