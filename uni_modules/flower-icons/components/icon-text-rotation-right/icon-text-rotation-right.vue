...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-text-rotation-right", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-text-rotation-right;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-text-rotation-right;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-text-rotation-right;}
	/* #endif */
