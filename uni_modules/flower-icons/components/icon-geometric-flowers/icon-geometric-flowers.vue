...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-geometric-flowers", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-geometric-flowers;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-geometric-flowers;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-geometric-flowers;}
	/* #endif */
