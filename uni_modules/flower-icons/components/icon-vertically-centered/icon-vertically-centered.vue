...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-vertically-centered", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-vertically-centered;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-vertically-centered;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-vertically-centered;}
	/* #endif */
