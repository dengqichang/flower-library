...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-alphabetical-reverse-order", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-alphabetical-reverse-order;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-alphabetical-reverse-order;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-alphabetical-reverse-order;}
	/* #endif */
