...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-union-selection", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-union-selection;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-union-selection;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-union-selection;}
	/* #endif */
