...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-arrow-right-up",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-arrow-right-up;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-arrow-right-up;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-arrow-right-up;}
	/* #endif */
