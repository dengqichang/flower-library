...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-hanfu-chinese", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-hanfu-chinese;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-hanfu-chinese;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-hanfu-chinese;}
	/* #endif */
