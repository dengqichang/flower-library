...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-doc-success", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-doc-success;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-doc-success;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-doc-success;}
	/* #endif */
