...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-internal-data", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-internal-data;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-internal-data;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-internal-data;}
	/* #endif */
