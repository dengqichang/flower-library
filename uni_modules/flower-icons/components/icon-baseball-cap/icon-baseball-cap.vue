...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-baseball-cap", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-baseball-cap;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-baseball-cap;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-baseball-cap;}
	/* #endif */
