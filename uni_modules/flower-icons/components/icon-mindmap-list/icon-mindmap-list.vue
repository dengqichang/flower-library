...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-mindmap-list", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-mindmap-list;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-mindmap-list;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-mindmap-list;}
	/* #endif */
