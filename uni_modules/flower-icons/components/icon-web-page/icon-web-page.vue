...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-web-page",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-web-page;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-web-page;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-web-page;}
	/* #endif */
