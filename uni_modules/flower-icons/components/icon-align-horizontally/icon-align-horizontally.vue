...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-align-horizontally",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-align-horizontally;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-align-horizontally;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-align-horizontally;}
	/* #endif */
