...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-quote",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-quote;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-quote;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-quote;}
	/* #endif */
