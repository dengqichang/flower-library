...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-music-rhythm", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-music-rhythm;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-music-rhythm;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-music-rhythm;}
	/* #endif */
