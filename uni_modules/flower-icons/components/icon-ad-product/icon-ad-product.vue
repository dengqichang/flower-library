...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-ad-product", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-ad-product;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-ad-product;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-ad-product;}
	/* #endif */
