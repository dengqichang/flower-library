...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-flip-horizontally",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-flip-horizontally;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-flip-horizontally;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-flip-horizontally;}
	/* #endif */
