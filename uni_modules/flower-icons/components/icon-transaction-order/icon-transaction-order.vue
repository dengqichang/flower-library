...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-transaction-order", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-transaction-order;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-transaction-order;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-transaction-order;}
	/* #endif */
