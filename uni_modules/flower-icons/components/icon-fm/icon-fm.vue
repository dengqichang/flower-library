...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-fm",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-fm;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-fm;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-fm;}
	/* #endif */
