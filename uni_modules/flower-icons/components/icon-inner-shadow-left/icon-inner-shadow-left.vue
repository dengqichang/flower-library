...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-inner-shadow-left",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-inner-shadow-left;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-inner-shadow-left;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-inner-shadow-left;}
	/* #endif */
