...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-grid-nine", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-grid-nine;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-grid-nine;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-grid-nine;}
	/* #endif */
