...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-converging-gateway", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-converging-gateway;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-converging-gateway;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-converging-gateway;}
	/* #endif */
