...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-one-to-many", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-one-to-many;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-one-to-many;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-one-to-many;}
	/* #endif */
