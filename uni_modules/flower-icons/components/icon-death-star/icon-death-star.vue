...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-death-star",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-death-star;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-death-star;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-death-star;}
	/* #endif */
