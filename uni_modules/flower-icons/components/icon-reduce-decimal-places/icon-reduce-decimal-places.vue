...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-reduce-decimal-places", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-reduce-decimal-places;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-reduce-decimal-places;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-reduce-decimal-places;}
	/* #endif */
