...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-preview-open", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-preview-open;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-preview-open;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-preview-open;}
	/* #endif */
