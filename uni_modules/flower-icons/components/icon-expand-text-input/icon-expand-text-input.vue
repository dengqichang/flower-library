...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-expand-text-input", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-expand-text-input;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-expand-text-input;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-expand-text-input;}
	/* #endif */
