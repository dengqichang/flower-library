...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-potentiometer", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-potentiometer;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-potentiometer;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-potentiometer;}
	/* #endif */
