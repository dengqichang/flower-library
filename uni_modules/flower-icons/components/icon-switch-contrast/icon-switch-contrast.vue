...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-switch-contrast", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-switch-contrast;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-switch-contrast;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-switch-contrast;}
	/* #endif */
