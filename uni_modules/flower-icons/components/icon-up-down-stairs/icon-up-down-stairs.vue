...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-up-down-stairs", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-up-down-stairs;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-up-down-stairs;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-up-down-stairs;}
	/* #endif */
