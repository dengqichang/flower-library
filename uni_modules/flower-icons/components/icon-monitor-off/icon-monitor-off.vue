...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-monitor-off", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-monitor-off;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-monitor-off;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-monitor-off;}
	/* #endif */
