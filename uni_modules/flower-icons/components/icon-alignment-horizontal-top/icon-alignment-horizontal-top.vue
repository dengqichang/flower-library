...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-alignment-horizontal-top", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-alignment-horizontal-top;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-alignment-horizontal-top;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-alignment-horizontal-top;}
	/* #endif */
