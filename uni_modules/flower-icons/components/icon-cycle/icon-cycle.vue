...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-cycle",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-cycle;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-cycle;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-cycle;}
	/* #endif */
