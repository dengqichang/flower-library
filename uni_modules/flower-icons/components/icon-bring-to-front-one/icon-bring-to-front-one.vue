...
<script>
	...
	domModule.addRule('fontFace', {'fontFamily': "flower-icon-bring-to-front-one",'src': "url('" + iconUrl + "')"});
	// #endif
	export default {
		props: {
...
<style scoped>
	/* #ifndef APP-NVUE */
	@font-face {font-family: flower-icon-bring-to-front-one;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-bring-to-front-one;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-bring-to-front-one;}
	/* #endif */
