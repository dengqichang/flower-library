...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-alignment-right-center", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-alignment-right-center;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-alignment-right-center;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-alignment-right-center;}
	/* #endif */
