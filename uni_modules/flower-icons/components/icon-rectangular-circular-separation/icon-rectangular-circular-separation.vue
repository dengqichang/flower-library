...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-rectangular-circular-separation", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-rectangular-circular-separation;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-rectangular-circular-separation;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-rectangular-circular-separation;}
	/* #endif */
