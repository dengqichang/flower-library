...
<script setup lang="ts">
	...
	domModule.addRule('fontFace', { 'fontFamily': "flower-icon-transfer-data", 'src': "url('" + iconUrl + "')" });
	// #endif
...
<style scoped>
	...
	@font-face {font-family: flower-icon-transfer-data;src: url('iconfont.ttf') format('truetype');}
	.flower-icons {font-family: flower-icon-transfer-data;}
	/* #endif */
	/* #ifdef APP-NVUE */
	.flower-icons {font-family: flower-icon-transfer-data;}
	/* #endif */
